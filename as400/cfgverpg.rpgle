     ...
     H*
     H* Compiler flags.
     HDFTACTGRP(*NO) ACTGRP(*CALLER) CVTOPT(*DATETIME) ALWNULL(*USRCTL)
     H*
     ...
     H*     40: Indicate show run or show ver. (DSPF)
     ...
     C                   PARM                    TYP$              3
     C*
     C* Provide Keylist for selecting records as desired.
     C     POSKEY        KLIST
     C                   KFLD                    HOSTNAME$
     C                   KFLD                    TYP$
     C*
...
E01  C                   ENDSL
     ...
     C                   EXSR      CLEARSFL
     C*
     C* Jump to first record of desired host and type.
     C     POSKEY        SETLL     SHOWRUNVER
     C*
     C* Read loop start.
     C     1             DO        9999
     C     POSKEY        READE     SHOWRUNVER                             34
     C     *IN34         IFEQ      *ON
     C                   LEAVE
     C                   ENDIF
     C*
