     ...
     C*
     C     AC_TYPE       CHAIN(EN) ACMATCHTBL
     C* Handle File errors.
     C                   EVAL      FSTAT=%STATUS(ACMATCHPF)
     C     FSTAT         IFGT      *ZERO
     C                   SELECT
     C     FSTAT         WHENEQ    12
     ...
     C                   ENDIF
     C*
     C                   MOVE      AC_VER        VERS#OLD
     C                   MOVE      AC_VER        VERS#NEW
     C*
     C                   EXFMT     REPVERFRM
     C*
     ...
     C                   ENDIF
     C*
     C* Position outselves for further READEs.
     ...
     C                   ENDIF
     C*
     C                   MOVE      VERS#NEW      AC_VER
     C*
     C                   UPDATE(E) REPLACETBL
     C                   EVAL      FSTAT=%STATUS(ACMATCHPF)
     C     FSTAT         IFGT      *ZERO
     ...
     C                   SELECT
     C     CSFLD         WHENEQ    'AC_TYPE'
     C                   MOVE      *ON           *IN60
     C     CSFLD         WHENEQ    'AC_VER'
     C                   MOVE      *ON           *IN61
     C                   ENDSL
     C                   ENDIF
     C*
